...
import (
	...
	"github.com/xh23123/IT_hftcommon/pkg/exampleExchange/binance/go-binance/v2/delivery"
...
func (c *Client) NewGetNextHourlyInterestRateService() *GetNextHourlyInterestRateService {
	return &GetNextHourlyInterestRateService{c: c}
}

func (c *Client) NewListMarginDustService() *ListMarginDustService {
	return &ListMarginDustService{c: c}
}

func (c *Client) NewMarginDustTransferService() *MarginDustTransferService {
	return &MarginDustTransferService{c: c}
}
...
// NewListMarginOpenOrdersService init list margin open orders service
func (c *Client) NewCancelOpenMarginOrdersService() *CancelOpenMarginOrdersService {
