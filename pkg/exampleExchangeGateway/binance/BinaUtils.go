...
import (
	...
	"github.com/xh23123/IT_hftcommon/pkg/exampleExchangeGateway/binance/go-binance/v2/unimargin"
	"go.uber.org/zap"
)
...
var BinancePluginPrefix string
...
func RegisterSystemSymbols(symbols []string) {
	...
	common.Logger.Info("PluginBalance RegisterSystemSymbols ",
...
func GetBinanceAccount(accountIndex common.AccountIdx) string {
	return fmt.Sprintf("%s%d", BinancePluginPrefix, accountIndex)
}
