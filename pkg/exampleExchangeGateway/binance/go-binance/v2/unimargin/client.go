...
import (
	...
	"github.com/xh23123/IT_hftcommon/pkg/exampleExchangeGateway/binance/go-binance/v2/common"
)
...
const (
	...
	OpenOrderLoss           UserDataEventType = "openOrderLoss"
	LiabilityChange         UserDataEventType = "liabilityChange"
	OutboundAccountPosition UserDataEventType = "outboundAccountPosition"
	BalanceUpdate           UserDataEventType = "balanceUpdate"
	ExecutionReport         UserDataEventType = "executionReport"

	UM InstrumentType = "UM"
	CM InstrumentType = "CM"
...
// NewCreateUmOrderService init creating order service
...
// NewCreateCmOrderService init creating order service
...
// NewCancelUmOrderService init cancel order service
...
// NewCancelAllUmOpenOrdersService init cancel all open orders service
func (c *Client) NewCancelAllUmOpenOrdersService() *CancelAllUmOpenOrdersService {
	return &CancelAllUmOpenOrdersService{c: c}
}

// NewCancelAllUmOpenOrdersService init cancel all open orders service
func (c *Client) NewCancelAllCmOpenOrdersService() *CancelAllCmOpenOrdersService {
	return &CancelAllCmOpenOrdersService{c: c}
}

// NewCancelAllUmOpenOrdersService init cancel all open orders service
func (c *Client) NewCancelAllMarginOpenOrdersService() *CancelOpenMarginOrdersService {
	return &CancelOpenMarginOrdersService{c: c}
}

// NewListUmOpenOrdersService init list open orders service
func (c *Client) NewListUmOpenOrdersService() *ListUmOpenOrdersService {
	return &ListUmOpenOrdersService{c: c}
}

// NewListCmOpenOrdersService init list open orders service
func (c *Client) NewListCmOpenOrdersService() *ListCmOpenOrdersService {
	return &ListCmOpenOrdersService{c: c}
}
...
// NewGetPositionService init balance service
func (c *Client) NewGetUmPositionService() *GetUmPositionService {
	return &GetUmPositionService{c: c}
}

// NewGetPositionService init balance service
func (c *Client) NewGetCmPositionService() *GetCmPositionService {
	return &GetCmPositionService{c: c}
}
...
// NewChangeUmPositionModeService init change position mode service
func (c *Client) NewChangeUmPositionModeService() *ChangeUmPositionModeService {
	return &ChangeUmPositionModeService{c: c}
}

// NewChangeCmPositionModeService init change position mode service
